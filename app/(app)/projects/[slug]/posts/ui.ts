export const cardClass = "rounded-xl bg-background";
export const inputClass = "h-10 rounded-md border border-input bg-background px-3";
export const inputMutedClass =
  "h-10 rounded-md border border-input bg-muted px-3 text-sm text-muted-foreground";
export const inputNarrowClass =
  "h-10 rounded-md border border-input bg-background px-3 w-full max-w-[200px]";
export const inputNarrowMutedClass =
